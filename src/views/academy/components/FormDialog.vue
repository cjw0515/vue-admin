  ...
  <div>
    ...
    >
      ...
      >
        ...
        <!-- 운영 -->
        <el-card shadow="hover" class="box-card" v-if="formDialogData.dialogStatus == 'update'">
          <div slot="header" class="clearfix">
...
import { generateInstiData, generateInstiAddition, dataDivider } from "@/utils/insti/";
