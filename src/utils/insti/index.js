export function dataDivider() {
    ...
    this.makePrefixedTime = function (timeText) {
        ...
        let sh = timeText.split(",")[0].split(".")[0];
        let sm = timeText.split(",")[0].split(".")[1];
        let eh = timeText.split(",")[1].split(".")[0];
        let em = timeText.split(",")[1].split(".")[1];
        ...
        data.forEach(o => {
            if (o.seq == 8 && o.itemName === "OT") {
                ...
                daysOT = [
                    ...
                    {
                        ...o,
                        openStat: o.itemProperty == "0" ? false : true,
